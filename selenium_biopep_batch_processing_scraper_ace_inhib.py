...
class BIOPEPAnalyzer:
    ...
    def extract_sequences(self):
        try:
            ...
            print(f"{len(filtered_tables)} tables selected with 'Sequence' column")

            for table, rows, headers, header_idx in filtered_tables:
                seq_idx = act_idx = None
                ...
                if seq_idx is None or act_idx is None:
                    print("Skipping table: missing 'Sequence' or 'Activity' columns")
                    continue
            ...
            if not self.results:
                print("No sequences with 'ACE inhibitor' activity found")
